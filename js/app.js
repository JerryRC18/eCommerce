...
const currrentProductTitle = document.querySelector(".productTitle")
...
menuItems.forEach( (item, index) => {
    item.addEventListener("click", () => {
        ...
        currrentProductTitle.textContent = choosenProduct.title
        currrentProductPrice.textContent = choosenProduct.price
